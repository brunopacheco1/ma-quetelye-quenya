...
This project uses `babelquarto` to support multiple languages. To start a new translation:
- Refer to the `babelquarto` documentation for adding a new language sub-directory.
